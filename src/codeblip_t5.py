...
# class CodeBlipT5(CodeBlip):
#     def __init__(self, stage1_qformer, stage1_query_tokens, num_query_token=32, t5_model='google/flan-t5-xl', prompt="Translate from Java to C#", max_source_len=512,
...
#         # todo randomly split target code into two parts : input and output and feed into t5

#         with self.maybe_autocast(dtype=torch.float16):

#             # todo this is wrong, make it blank?
#             input_tokens = self.t5_tokenizer(
#                 source_code,
#                 padding="longest",
#                 truncation=True,
